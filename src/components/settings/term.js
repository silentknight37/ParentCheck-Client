        ...
        return fetch(`setting/getAcademicTerm`, requestOptions)
            ...
            .then(response => {
                response.academicTerms.map(i =>
                    academicTermList.push({ id: i.id, term: i.term, yearAcademic: i.yearAcademic, fromDate: new Date(i.fromDate).toDateString(), toDate: new Date(i.toDate).toDateString(), isActive: i.isActive ? "True" : "False", action: <Link className="btn btn-light" onClick={() => this.selectedTemplate(i)}><i className="icofont icofont-ui-edit"></i></Link> })
                )
                this.setState({
                                                        ...
                                                        <div className="card-body">
                                                            <div className="form-row">
                                                                <div className="form-group col-12">
                                                                    ...
                                                                    <input className="form-control" id="term" disabled={this.state.isEdit} type="text" aria-describedby="term" value={this.state.term} onChange={e => this.handleChange({ term: e.target.value })} placeholder="Academic Term" />
