...

                                    {
                                        this.state.selectedOpenEmail && (
                                            <Modal isOpen={this.state.isEmailOpen} toggle={this.handleEmailModalToggle} size="lg">
                                                                    ...
                                                                    <div role="tabpanel" aria-labelledby="pills-darkprofile-tab">
                                                                        <div className="email-content">
                                                                            <div className="email-wrapper">
                                                                                {this.state.selectedOpenEmail.templateId > 0 && (<p>
                                                                                    Request Form : {this.state.selectedOpenEmail.templateName}
                                                                                </p>)}
                                                                                <p>{this.getHtmlContent()}</p>
                                                                                <hr/>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                ...
                                                <ModalFooter>
                                                    {this.state.boxType == "Inbox" && (<button className="btn btn-primary mr-1" disabled={this.state.isSubmited && this.state.isValidSubmit} type="button" onClick={(e) => this.submitSMS(e)}>{'Reply'}</button>)}
                                                    <button className="btn btn-primary mr-1" type="button" onClick={(e) => this.handleEmailModalToggle()}>{'Cancel'}</button>
                                                </ModalFooter>
                                            </Modal>
                                        )
                                    }
