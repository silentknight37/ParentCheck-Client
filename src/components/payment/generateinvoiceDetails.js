...
class GenerateInvoiceDetails extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            id: 0,
    ...
    render() {
        ...
        return this.state.InvoiceDetail && (
            <Fragment>
                <Breadcrumb title="Invoice Details" parent="Invoices" parentLink={createLink('/payment/generate-invoices')} isParentShow={true} />
...
export default withRouter(
    connect(mapStateToProps, mapDispatchToProps)(GenerateInvoiceDetails));